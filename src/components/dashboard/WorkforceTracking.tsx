...
export function WorkforceTracking() {
  ...
  // Sites with low availability derived from by_vendor (proxy)
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-3 border rounded-lg p-4">
              <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">
                Low Availability Vendors
              </h4>
              <div className="space-y-2">
                {shortfallVendors.length === 0 ? (
                  <div className="text-center py-6 text-sm text-muted-foreground">
                    All vendors at good capacity
                  </div>
                ) : (
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">
                          {(vendor.present ?? 0)}/{(vendor.total ?? 0)} present
                        </div>
                      </div>
                      <div className="flex items-center gap-1">
                        <StatusBadge
                          status={vendor.availability < 70 ? 'critical' : 'warning'}
                    ...
                    >
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className={cn(
                            'h-full rounded-full',
                            availability >= 90 ? 'bg-healthy' : availability >= 80 ? 'bg-warning' : 'bg-critical'
                          )}
