            ...
            <div className="col-span-3 space-y-3">
              ...
              <div className="border rounded-lg p-4 space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span>Completed</span>
                  <span className="font-semibold text-healthy">{ppm?.completed ?? 0}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span>Pending</span>
                  <span className="font-semibold">{ppm?.pending ?? 0}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span>Missed</span>
                  <span className="font-semibold text-critical">{ppm?.missed ?? 0}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span>Overdue</span>
                  <span className="font-semibold text-critical">{ppm?.overdue ?? 0}</span>
                </div>
              </div>
              ...
              {softServices && (
                <div className="border rounded-lg p-4">
                  ...
                  <div className={cn(
                    ...
                    softServices.completion_percentage >= 85 ? 'text-healthy' : softServices.completion_percentage >= 70 ? 'text-warning' : 'text-critical'
                  )}>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-medium text-healthy">{softServices.completed}</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-muted-foreground">Pending</span>
                      <span className="font-medium">{softServices.pending}</span>
                    </div>
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-muted-foreground">Overdue</span>
                      <span className="font-medium text-critical">{softServices.overdue}</span>
                    </div>
                  </div>
                </div>
              )}
