      ...
      <div className="container">
        ...
        {isLoading ? (
          <div className="grid grid-cols-12 gap-4">
            <Skeleton className="col-span-12 h-16 rounded-lg" />
            <Skeleton className="col-span-3 h-48 rounded-lg" />
            <Skeleton className="col-span-4 h-48 rounded-lg" />
            <Skeleton className="col-span-5 h-48 rounded-lg" />
          </div>
        ) : (
          <div className="grid grid-cols-12 gap-4">
            {/* Status Summary Tabs */}
                  ...
                  {data.priority_tickets.map(ticket => (
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <span className="text-xs font-medium w-28 shrink-0">{ticket.ticket_number}</span>
