  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Status Colors for Enterprise BI
        healthy: {
          DEFAULT: "hsl(var(--status-healthy))",
          bg: "hsl(var(--status-healthy-bg))",
          foreground: "hsl(var(--status-healthy-foreground))",
        },
        warning: {
        ...
        kpi: {
          ...
          up: "hsl(var(--kpi-trend-up))",
          down: "hsl(var(--kpi-trend-down))",
        },
        // Panel Colors
        panel: {
          overlay: "hsl(var(--panel-overlay))",
          bg: "hsl(var(--panel-bg))",
